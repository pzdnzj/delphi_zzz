...
type
  ...
  private
    ...
    [Column('nodeTypte_id', [])]
    FnodeTypte_id: Nullable<Integer>;
  ...
  public
    ...
    property nodeTypte_id: Nullable<Integer> read FnodeTypte_id write FnodeTypte_id;
  ...
  private
    ...
    FnodeTypte_id: TDictionaryAttribute;
  ...
  public
    ...
    property nodeTypte_id: TDictionaryAttribute read FnodeTypte_id;
...
begin
  ...
  FnodeTypte_id := TDictionaryAttribute.Create('nodeTypte_id');
